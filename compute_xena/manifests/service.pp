class compute_xena::service inherits compute_xena::params {
...
# Services needed
    ...
    if $::compute_xena::cloud_role == "is_prod_localstorage" {
    ...
    if $::compute_xena::cloud_role == "is_prod_sharedstorage" {
                  file { 'nova-instances':
                            path        => "/var/lib/nova/instances",
                            ensure      => directory,
                            require     => Package["openstack-nova-common"],
