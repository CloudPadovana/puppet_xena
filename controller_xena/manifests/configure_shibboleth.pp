class controller_xena::configure_shibboleth inherits controller_xena::params {
  ...
  file { "/etc/shibboleth/attribute-map.xml":
    ...
    group    => "root",
    mode     => "0644",
    source   => "puppet:///modules/controller_xena/attribute-map.xml",
    tag      => ["shibboleth_conf"],
  }

  controller_xena::configure_shibboleth::srvmetadata { "/etc/shibboleth/horizon-infn-metadata.xml":
  ...
  controller_xena::configure_shibboleth::srvmetadata { "/etc/shibboleth/keystone-infn-metadata.xml":
  ...
  controller_xena::configure_shibboleth::srvmetadata { "/etc/shibboleth/horizon-unipd-metadata.xml":
  ...
  controller_xena::configure_shibboleth::srvmetadata { "/etc/shibboleth/keystone-unipd-metadata.xml":
  ...
  file { "/etc/shibboleth/shibboleth2.xml":
    ...
    group    => "root",
    mode     => "0644",
    content  => template("controller_xena/shibboleth2.xml.erb"),
    tag      => ["shibboleth_conf"],
  }
  ...
  define srvmetadata ($entityid, $info_url, $sp_name, $sp_org) {
    file { "$title":
      ...
      group    => "root",
      mode     => "0644",
      content  => template("controller_xena/idem-template-metadata.xml.erb"),
      tag      => ["shibboleth_conf"],
    }
  }
