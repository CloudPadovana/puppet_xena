class controller_xena::configure_horizon inherits controller_xena::params {
  ...
  file { "/etc/httpd/conf.d/ssl.conf":
    ...
    group    => "root",
    mode     => "0644",
    content  => template("controller_xena/ssl.conf.erb"),
  }
  ...
  file { "/etc/httpd/conf.d/openstack-dashboard.conf":
    ...
    group    => "root",
    mode     => "0644",
    content  => file("controller_xena/openstack-dashboard.conf"),
  }
  ...
  file { "/etc/openstack-dashboard/local_settings":
    ...
    group    => "apache",
    mode     => "0640",
    content  => template("controller_xena/local_settings.erb"),
  }
...
#  }
  ...
  if $enable_aai_ext {
    ...
    exec { "download_cap_repo":
      ...
      unless  => "/bin/grep Xena /etc/yum.repos.d/openstack-security-integrations.repo 2>/dev/null >/dev/null",
    }
    ...
    file { "/usr/share/openstack-dashboard/openstack_dashboard/local/local_settings.d/_1002_aai_settings.py":
      ...
      group    => "apache",
      mode     => "0640",
      content  => template("controller_xena/aai_settings.py.erb"),
    }
    ...
    file { "/usr/share/openstack-dashboard/openstack_dashboard/local/local_settings.d/_1003_infnaai_settings.py":
      ...
      group    => "apache",
      mode     => "0640",
      content  => template("controller_xena/infnaai_settings.py.erb"),
    }
    ...
    file { "/usr/share/openstack-dashboard/openstack_dashboard/local/local_settings.d/_1003_unipdsso_settings.py":
      ...
      group    => "apache",
      mode     => "0640",
      content  => template("controller_xena/unipdsso_settings.py.erb"),
    }
    ...
    file { "/usr/share/openstack-dashboard/openstack_dashboard/local/local_settings.d/_1003_oidc_settings.py":
      ...
      group    => "apache",
      mode     => "0640",
      content  => template("controller_xena/oidc_settings.py.erb"),
    }
    ...
    file { "/etc/openstack-auth-shib/notifications/notifications_en.txt":
      ...
      group    => "root",
      mode     => "0644",
      content  => template("controller_xena/notifications_en.txt.erb"),
  ...
  file { "/etc/openstack-auth-shib/actions.conf":
    ...
    group    => "root",
    mode     => "0600",
    content  => template("controller_xena/actions.conf.erb"),
  }
  ...
  file { "/etc/cron.d/openstack-auth-shib-cron":
    ...
    group    => "root",
    mode     => '0644',
    content  => template("controller_xena/openstack-auth-shib-cron.erb"),
  }
