class controller_xena::pwl_access inherits controller_xena::params {
...
"
  ...
  File["nova_sshdir"] -> file {
	...
	"private_key":
	    source  => "puppet:///modules/controller_xena/$controller_xena::params::private_key",
	...
	"public_key":
            ...
            content => "$controller_xena::params::pub_key",
            owner   => nova,
            group   => nova;
